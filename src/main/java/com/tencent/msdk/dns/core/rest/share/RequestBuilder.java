...
public final class RequestBuilder {
    ...
    private static final String INET_REQUEST_FORMAT = "dn=%s&ip=%s&clientip=1&ttl=1&id=%s&alg=%s";
    private static final String INET6_REQUEST_FORMAT = "dn=%s&ip=%s&clientip=1&ttl=1&id=%s&alg=%s&type=aaaa";
    private static final String DOUB_REQUEST_FORMAT = "dn=%s&ip=%s&clientip=1&ttl=1&id=%s&alg=%s&type=addrs";
    ...
    private static String buildRequest(String encryptedHostname, String bizId, String alg, String format) {
        ...
        return String.format(Locale.US,
                format, encryptedHostname, ip, bizId, alg);
    }
